            ...
            <section class="insc" style="width: 800px;height: 1300px;">
                ...
                <form method="POST" action="">   
                            ...
                            <div class="tete">
                                <table>
                                    <tr>
                                        ...
                                        <td align="center"><label for="aire"><strong class="second1">unite de santé</strong></label></td>  
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><label for="aire"><?php echo $_SESSION['aire_c']; ?></label> </td>  
                    ...
                    <div class="fieldsets">
                        ...
                        <button type=submit formaction="http://localhost/pdf_project/structure.php" align="center">Etat de sortie</button>
